...
db.once('open', () => {
  ...
  app.get('/batsmen.html', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'batsmen.html'));
  });

  app.get('/bowlers.html', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'bowlers.html'));
  });

  app.get('/wicketkeepers.html', (req, res) => {
    res.sendFile(path.join(__dirname, 'public', 'wicketkeepers.html'));
  });
